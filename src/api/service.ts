...
// 获取用户信息
export function getAuth (): Promise<Ajax.AjaxResponse> | any {
  return ax.get('/auth')
            .then((res: Ajax.AxiosResponse) => res.data)
            .catch((e: string) => console.error(e))
}
...
// 七牛
export function getQiniu (): Promise<Ajax.AjaxResponse> | any {
  return ax.get('/qiniu')
            .then((res: Ajax.AxiosResponse) => res.data)
            .catch((e: string) => console.error(e))
}
...
// 获取网站配置项
export function getOpt (): Promise<Ajax.AjaxResponse> | any {
...
// 获取评论
export function getComments (params: IParams): Promise<Ajax.AjaxResponse> | any {
